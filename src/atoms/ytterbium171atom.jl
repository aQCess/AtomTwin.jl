...
Total linewidth of the two empirical transitions is a fit parameter with fitted value 53.761 MHz.
...
const YB171_POLARIZABILITY_3P1 = PolarizabilityModel(
    ...
    [
        ...
        (freq_THz = 440.775408,  gamma_MHz = 3.604,  state_f = "(6s7s) 3S1",    J_f = 1),     # (6s7s) 3S1   #
        ...
        (freq_THz = 778.975785,  gamma_MHz = 20.322, state_f = "Empirical J=1", J_f = 1),     # Empirical J=1
        (freq_THz = 778.975785,  gamma_MHz = 33.439, state_f = "Empirical J=2", J_f = 2),     # Empirical J=2
    ];
    J_i = 1,
    offset_Hz_per_Wm2 = 0.0,
